		...
		<table  class=editTable cellSpacing=1 cellPadding=0 width="100%" align=center border=0>
			<tr>
    			 ...
    			 <tr>
    				...
    				<% List<CustomerCareInfo> careList = (List<CustomerCareInfo>)request.getAttribute("careList");
						if(careList!=null && careList.size()>0){
								for(int i=0;i<careList.size();i++){ 
								CustomerCareInfo careInfo = careList.get(i);
					%>
					<tr>
					<td colspan="1" bgcolor="#FFFFFF"><div align="center"><%=careInfo.getCareTheme() %></div></td>
					<td colspan="1" bgcolor="#FFFFFF"><div align="center"><%=careInfo.getCareNexttime() %></div></td>
					<td colspan="1" bgcolor="#FFFFFF"><div align="center"><%=careInfo.getCustomerName() %></div></td>
					</tr>
					<%}}else{ %>
          						<tr>
    ...
    <td bgcolor="#FFFDF0">
		<div align="center" id="div2">
			...
			<tr>
    			...
    			<% List<LinkRecordInfo> linkRecordList = (List<LinkRecordInfo>)request.getAttribute("linkrecorsList");
    		...
    		<tr>
					<td colspan="1" bgcolor="#FFFFFF"><div align="center"><%=linkRecordInfo.getLinkTheme() %></div></td>
					<td colspan="1" bgcolor="#FFFFFF"><div align="center"><%=linkRecordInfo.getLinkType() %></div></td>
					<td colspan="1" bgcolor="#FFFFFF"><div align="center"><%=linkRecordInfo.getLinkNexttime() %></div></td>
					<td colspan="1" bgcolor="#FFFFFF"><div align="center"><%=linkRecordInfo.getCustomerName() %></div></td>
   	 		</tr>
    ...
    <td width="50%" bgcolor="#FFFDF0">
		...
		<table  class=editTable cellSpacing=1 cellPadding=0 width="100%" align=center border=0>
    			 ...
    			 <tr>
					...
					%>
					<tr>
					<td colspan="1" bgcolor="#FFFFFF"><div align="center"><%=noticeInfo.getNoticeItem() %></div></td>
					<td colspan="1" bgcolor="#FFFFFF"><div align="center"><%=noticeInfo.getNoticeContent() %></div></td>
					<td colspan="1" bgcolor="#FFFFFF"><div align="center"><%=noticeInfo.getNoticeEndTime() %></div></td>
					<td colspan="1" bgcolor="#FFFFFF"><div align="center"><%=noticeInfo.getUserName() %></div></td>
					</tr>
					<%}}else{ %>
          						<tr>
										<td height="20" bgcolor="#FFFFFF" colspan="22"  align="center">
    ...
    <td bgcolor="#FFFDF0">
		<div align="center" id="div2">
			...
			<%List<CustomerInfo> customerList = (List<CustomerInfo>)request.getAttribute("customerList");
					...
					%>
    		<tr>
					<td colspan="1" bgcolor="#FFFFFF"><div align="center"><%=customerInfo.getCustomerName() %></div></td>
					<td colspan="1" bgcolor="#FFFFFF"><div align="center"><%=customerInfo.getCustomerBirthday()%></div></td>
					<td colspan="1" bgcolor="#FFFFFF"><div align="center"><%=customerInfo.getCustomerMobile() %></div></td>
					<td colspan="1" bgcolor="#FFFFFF"><div align="center"><%=customerInfo.getCustomerCondition() %></div></td>
   	 		</tr>
   	 		<%}}else{ %>
          						<tr>
										<td height="20" bgcolor="#FFFFFF" colspan="22"  align="center">
